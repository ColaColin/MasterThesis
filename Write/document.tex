...
-> Bandit Based Monte-Carlo Planning invents UCT in 2006, employing learnings of the Multi Armed Bandi problem.
-> Modification of UCT with Patterns in Monte-Carlo Go uses UCT on Go in 2006
-> MCTS starts to dominate in computer Go with programs such as Pachi or Crazy Stone.
-> AlphaGo first used the play random games out approach, AlpaZero skips that.
