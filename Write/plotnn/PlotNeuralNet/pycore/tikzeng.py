...
# Conv
def to_Conv( name, s_filer_x=256, s_filter_y=256, n_filer=64, offset="(0,0,0)", to="(0,0,0)", width=1, height=40, depth=40, caption=" " ):
    return r"""
\pic[shift={"""+ offset +"""}] at """+ to +""" 
    {Box={
        ...
        caption="""+ caption +r""",
        xlabel={{"""+ str(n_filer) +""", }},
        ylabel="""+ str(s_filter_y) +""",
        zlabel="""+ str(s_filer_x) +""",
        fill=\ConvColor,
        height="""+ str(height) +""",
        width="""+ str(width) +""",
        depth="""+ str(depth) +"""
