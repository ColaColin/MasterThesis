    ...
    def on_get(self, req, resp, param1, param2):
        ...
        if mode == "list":
            ...
            try:
                ...
                cursor.execute("select id, creation, run, acc_rnd_limited, acc_best_limited, acc_rnd_full, acc_best_full from networks where run = %s", (run_id, ))
