...
\only<1>{\includegraphics[scale=0.425]{framework_0}}
\only<2>{\includegraphics[scale=0.425]{framework_1}}
\only<3>{\includegraphics[scale=0.425]{framework_2}}
\only<4>{\includegraphics[scale=0.425]{framework_3}}
...
\end{itemize}
\only<6>{\center \includegraphics[scale=0.425]{hyper_compare0}}
\only<7>{\center \includegraphics[scale=0.425]{hyper_compare1}}
\only<8>{\center \includegraphics[scale=0.425]{hyper_compare2}}
\only<9>{\center \includegraphics[scale=0.425]{hyper_compare}}
...
\only<6>{\center \includegraphics[scale=0.425]{growNetwork0}}
\only<7>{\center \includegraphics[scale=0.425]{growNetwork1}}
\only<8>{\center \includegraphics[scale=0.425]{growNetwork}}
